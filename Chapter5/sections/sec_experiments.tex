...
\begin{figure}[t]
	...
	\begin{subfigure}[t]{0.24\textwidth}
    		\includegraphics[width=\textwidth]{Chapter5/img/uci/wine.pdf}
    		\caption{wine}
    		\label{fig:wine}
	\end{subfigure}
	\begin{subfigure}[t]{0.24\textwidth}
    		\includegraphics[width=\textwidth]{Chapter5/img/uci/breast_cancer.pdf}
    		\caption{breast cancer}
    		\label{fig:breast_cancer}
	\end{subfigure}
	\begin{subfigure}[t]{0.24\textwidth}
    		\includegraphics[width=\textwidth]{Chapter5/img/uci/adult.pdf}
    		\caption{adult}
    		\label{fig:adult}
	\end{subfigure}
	\begin{subfigure}[t]{0.24\textwidth}
    		\includegraphics[width=\textwidth]{Chapter5/img/mnist/mnist.pdf}
    		\caption{\MNIST}
    		\label{fig:mnist}
	\end{subfigure}
...
% \begin{figure}[ht]
%     \centering\includegraphics[width=0.6\textwidth]{Chapter5/img/mnist/mnist.pdf}
