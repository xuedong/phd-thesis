...
\newacronym{bpi}{BPI}{\emph{best-policy identification}}
...
\newacronym{automl}{AutoML}{\emph{automated machine learning}}

\newacronym{siab}{SIAB}{\emph{stochastic infinitely-armed bandits}}

\newacronym{niab}{NIAB}{\emph{non-stochastic infinitely-armed bandits}}

\newacronym{fms}{FMS}{\emph{full model selection}}

\newacronym{cash}{CASH}{\emph{combined algorithm selection and hyper-parameter optimization}}

\newacronym{nas}{NAS}{\emph{neural architecture search}}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% 			Acronymes (algorithmes)   				%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\newacronym{ucb}{\texttt{UCB}{}}{\underline{U}pper-\underline{C}onfidence \underline{B}ound}
...
\newacronym{lgc}{\textcolor{red}{\texttt{LinGame-C}{}}}{\underline{Lin}ear \underline{Game}-\underline{C}onvexified}
...
\newglossaryentry{sub-optimality gap}{
	name={\emph{sub-optimality gap}},
	description={},
	}
...
\newglossaryentry{generalized linear bandits}{
	name={\emph{generalized linear bandits}},
	description={},
	}
