...
\begin{figure}[ht]
  ...
  \end{subfigure}
  \begin{subfigure}{0.24\textwidth}
    \centering\includegraphics[width=\textwidth]{Chapter4/img/himmelblau.pdf}
    \caption{Himmelblau}
  \end{subfigure}
  \begin{subfigure}{0.24\textwidth}
...
\begin{figure}[ht]
  ...
  \begin{subfigure}{0.49\textwidth}
    \centering\includegraphics[width=\textwidth]{Chapter4/img/branin_plot.pdf}
    \caption{Branin}
  \end{subfigure}
  \begin{subfigure}{0.49\textwidth}
    \centering\includegraphics[width=\textwidth]{Chapter4/img/himmelblau_plot.pdf}
    \caption{Himmelblau}
  \end{subfigure}
  \begin{subfigure}{0.49\textwidth}
    \centering\includegraphics[width=\textwidth]{Chapter4/img/rosenbrock_plot.pdf}
    \caption{Rosenbrock}
  \end{subfigure}
  \begin{subfigure}{0.49\textwidth}
    \centering\includegraphics[width=\textwidth]{Chapter4/img/rastrigin_plot.pdf}
