...
\begin{itemize}
    \item Omar Darwiche Domingues, Yannis Flet-Berliac, Edouard Leurent, Pierre Ménard, and Xuedong Shang. Reinforcement learning via optimistic supervised learning: A simple and effective strategy for exploration. Work in progess, 2021.
    \item Omar Darwiche Domingues, Yannis Flet-Berliac, Edouard Leurent, Pierre Ménard, and Xuedong Shang. rlberry - A reinforcement learning library for research and education. Github Repository, 2021
    \item Xuedong Shang, Igor Colin, Merwan Barlier, Ludovic Dos Santos. Safe best-arm-identification in linear bandits. Submitted, 2021.
    \item Pierre Ménard, Omar Darwiche Domingues, Xuedong Shang, and Michal Valko. UCB momentum Q-learning: Correcting bias without forgetting. Submitted, 2021.
    \item Rémy Degenne, Pierre Ménard, Xuedong Shang, and Michal Valko. Gamification of pure exploration for linear bandits. In Proceedings of the 37th International Conference on Machine Learning (ICML), 2020.
    \item uedong Shang, Rianne de Heide, Emilie Kaufmann, Pierre Ménard, and Michal Valko. Fixed-confidence guarantees for Bayesian best-arm identification. In Proceedings of the 23rd International Conference on Artificial Intelligence and Statistics (AIStats), 2020.
    \item Xuedong Shang, Han Shao and Jian Qian. Stochastic bandits with vector losses: Minimizing infinite norm of relative losses. Submitted, 2020.
    \item Xuedong Shang, Emilie Kaufmann, and Michal Valko. A simple dynamic bandit algorithm for hyper-parameter tuning. In 6th Workshop on Automated Machine Learning at International Conference on Machine Learning (ICML-AutoML), 2019.
    \item Xuedong Shang, Emilie Kaufmann, and Michal Valko. General parallel optimisation without a metric. In Proceedings of the 30th International Conference on Algorithmic Learning Theory (ALT), 2019.
    \item Xuedong Shang, Emilie Kaufmann, and Michal Valko. Adaptive black-box optimisation got easier: HCT needs only local smoothness. In 14th European Workshop on Reinforcement Learning (EWRL), 2018.
\end{itemize}
