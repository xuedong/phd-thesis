...
$\cB eta(\cdot,\cdot)$ denotes a Beta distribution.

$\cB ern(\cdot)$ denotes a Bernoulli distribution.

$\cB(\cdot)$ denotes a Binomial distribution.

$\cN(\cdot,\cdot)$ denotes a normal distribution.
...
\begin{leftbar}[examplebar]
    We compute the KL divergence between two Bernoulli distributions $\mathbb{P}\sim\cB ern(\mu_1)$ and $\mathbb{Q}\sim\cB ern(\mu_2)$, we denote by
     \[
