...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\includeonly{Chapter0,Chapter1,Appendices}
...
\date\today
\jurya{Mme Emilie \scshape{Kaufmann}}{Charg\'ee de recherche, CNRS, SequeL}{Co-encadrante de Th\`ese}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{appendix}
		\pagenumbering{Roman}
		\input{Appendices/Appendices}				% Figures en annexe
