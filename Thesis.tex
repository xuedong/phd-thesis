...
\include{Preamble}		% Liste des packages et de leurs options
\include{Macros/Commands}	% Commandes et environnements perso
\include{Macros/names}
\include{Macros/macros}
\include{Macros/todos}
\include{Front/Front}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\includeonly{Chapter0,chapter1,chapter2,Appendices}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\begin{appendix}
		%\pagenumbering{Roman}
		\include{AppendixA/Maths}				% Figures en annexe
