...
%\AddToShipoutPicture*{\EtiquetteThese}
  ...
  \centering
    ...
    \vspace{1cm}
      {\Large \'{E}cole doctorale 631 : Math\'ematiques, sciences du num\'erique et de leurs interactions}\\
    \vspace{1cm}
      {\huge
    ...
    \vspace{0.5cm}
    	\@date \\
        \textbf{Centre de Recherche en Informatique, Signal et Automatique de Lille (CRIStAL)}\\
        \textbf{UMR 9189 Équipe Scool/SequeL, 59650, Villeneuve d’Ascq, France}\\
    \par\rule{10cm}{0.4pt}\\
    \vfill
